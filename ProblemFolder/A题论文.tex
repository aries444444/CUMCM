...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{fig05_q2.png}
  \caption{问题 2 前 3 h 的温度演化：不同径向位置的温度随时间变化，体现双向耦合模型下热场达到近似均匀的过程。}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{fig09_问题4_含收缩含水率演化.png}
