...
问题2：0--10800 s（主网格 Δr=0.125 mm, Δt=0.25 s）-> 表3/表4 + result2.xlsx（每 1 s、每 0.1 cm）。
...
R, dr, N = 0.02, 1.25e-4, 161          # 半径 2 cm，主网格 0.125 mm，161 节点
r = np.arange(N) * dr
T0, C0 = 28.0, 2.55
h, hm = 25.0, 8e-7
...
# ================= 问题2：0--10800 s，主网格 Δr=0.125 mm, Δt=0.25 s =================
...
# result2.xlsx：每 1 s、每 0.1 cm（0.125 mm 网格上每 8 节点一列）
...
# V2 空间收敛：0.5 mm 与 0.25 mm 两套网格（同 Δt=0.25 s、同位置采样）
