...
依据 scientific-illustration-guide（2026-09-13 仓库最新版）：
  - 组件+连接的程序化架构图（FancyBboxPatch / FancyArrowPatch）
  - 色盲安全：不以红+绿区分不同类别；元素直接标注而非依赖图例
  - 文本对比度 WCAG AA；矢量 PDF + 300dpi PNG 双导出
...
# Nature 扁平风格：低饱和底色 + 深色描边；检验层用中性石板灰（避免红绿配对）
...
C_CHECK = ('#ECEFF1', '#455A64')   # 检验：浅灰底/石板灰边
SUB = '#444444'
ARROW = '#666666'
